...
do
    ...
    CUDA_VISIBLE_DEVICES=$gpu_id nohup python3 /root/Patch-Matters/description_generate/multi_process.py \
        --input_file /test_data/did_bench.json \
        --output_folder /root/Patch-Matters/description_generate \
        --chunk_index $chunk_index \
        --chunk_num $chunk_num \
        --node_index $node_index \
        --node_num $node_num > /root/Patch-Matters/description_generate/description/test_$chunk_index.log 2>&1 &
done
